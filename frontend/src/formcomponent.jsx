...
import { User, Mail, Lock, BadgeInfo } from 'lucide-react';
...
export default function UserForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden w-1/3">
      {/* Shimmer animation background */}
      <div className="absolute inset-0 z-0 shimmer-bg " />

      <form
        onSubmit={handleSubmit(onSubmit)}
        className="relative z-10 bg-white/10 border-2 border-silver text-white backdrop-blur-xl rounded-xl p-8 w-full max-w-xl shadow-2xl"
      >
        ...
        className="bg- dark:bg-slate-900 text-black dark:text-white border-neutral-200 dark:border-slate-800"
      >
        Submit
      </Button>
      </form>
